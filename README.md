# Домашнее задание к занятию "`Обзор систем IT-мониторинга`" - `Цветкова Дарья`
...
![img.png](img/task-3.png)#### Требования к результату
...
## Ответ:
В данном задание я думаю, что лучше создать все-таки один алерт,
где уже предусмотрен alarm и warn по
заданным значениям, но
так как по заданию сказано создать два алерта, то придерживаюсь ему:

![](img/task-3.png)

Ниже представлен профиль оповещения:
![](img/task-4.png)

Конфигурации алертов:

Первый алерт на оповещение:
![](img/task-5.png)

Второй алерт на оповещение:
![](img/task-6.png)
